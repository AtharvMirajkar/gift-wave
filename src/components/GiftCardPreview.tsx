...
const GiftCardPreview = () => {
  ...
  const getTemplateStyle = () => {
    const baseStyle = {
      ...
      icon: (
        <Gift className="w-6 h-6 sm:w-8 sm:h-8" style={{ color: textColor }} />
      ),
      pattern: "",
    ...
    switch (template) {
      case "birthday":
        return {
          ...
          pattern: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='${encodeURIComponent(
            textColor
      ...
      case "anniversary":
        return {
          ...
          pattern: `url("data:image/svg+xml,%3Csvg width='52' height='26' viewBox='0 0 52 26' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='${encodeURIComponent(
            textColor
      ...
      case "event":
        return {
          ...
          pattern: `url("data:image/svg+xml,%3Csvg width='48' height='32' viewBox='0 0 48 32' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='${encodeURIComponent(
            textColor
          )}' fill-opacity='0.15'%3E%3Cpath d='M27 32c0-3.314 2.686-6 6-6 5.523 0 10-4.477 10-10S38.523 6 33 6c-3.314 0-6-2.686-6-6h2c0 2.21 1.79 4 4 4 6.627 0 12 5.373 12 12s-5.373 12-12 12c-2.21 0-4 1.79-4 4h-2zm-6 0c0-3.314-2.686-6-6-6-5.523 0-10-4.477-10-10S9.477 6 15 6c3.314 0 6-2.686 6-6h-2c0 2.21-1.79 4-4 4C8.373 4 3 9.373 3 16s5.373 12 12 12c2.21 0 4 1.79 4 4h2z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`,
        };
      default:
        return baseStyle;
    }
  ...
  return (
    <motion.div
      ...
      className="relative rounded-xl shadow-2xl overflow-hidden min-w-[280px] sm:min-w-[320px] w-full max-w-lg mx-auto"
      style={{
        ...
        >
          <div className="flex items-center justify-between mb-4 sm:mb-6">
            ...
            <motion.div
              ...
              className="w-8 h-8 sm:w-12 sm:h-12 rounded-full backdrop-blur-sm flex items-center justify-center"
          ...
          >
            ...
            <p
              className="text-base sm:text-lg md:text-xl leading-relaxed drop-shadow-lg"
              style={{ color: textColor }}
            >
            ...
            <div className="flex items-center justify-between pt-4 sm:pt-6">
              <p
                className="text-sm sm:text-base md:text-lg italic drop-shadow-lg"
                style={{ color: textColor }}
              >
                From, {senderName || "Someone special"}
              </p>
              <motion.div whileHover={{ rotate: 10 }} className="opacity-75">
                {templateStyle.icon}
              </motion.div>
            </div>
          </motion.div>
